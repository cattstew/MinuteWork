...
public class nature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timestampleft = findViewById(R.id.timeStampleft4);
        timestampright = findViewById(R.id.timeStampright4);
        seekbar = findViewById(R.id.seekBar4);
        playbutton = findViewById(R.id.playbutton4);
        backward = findViewById(R.id.backward4);
        forward = findViewById(R.id.forward4);
        musicPlayer = MediaPlayer.create(this, R.raw.naturemusic1);
        ...
        songs.add(0, R.raw.naturemusic1);
        songs.add(0, R.raw.naturemusic2);
        songs.add(0, R.raw.naturemusic3);
