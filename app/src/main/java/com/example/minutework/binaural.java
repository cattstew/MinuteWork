...
public class binaural extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timestampleft = findViewById(R.id.timeStampleft2);
        timestampright = findViewById(R.id.timeStampright2);
        seekbar = findViewById(R.id.seekBar2);
        playbutton = findViewById(R.id.playbutton2);
        backward = findViewById(R.id.backward2);
        forward = findViewById(R.id.forward2);
        musicPlayer = MediaPlayer.create(this, R.raw.binauralbeats1);
        ...
        ArrayList<Integer> songs = new ArrayList<>();
                ...
                songs.add(0, R.raw.binauralbeats1);
                songs.add(0, R.raw.binauralbeats2);
